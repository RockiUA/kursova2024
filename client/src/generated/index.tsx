...
export type Authenticated = {
  ...
  readonly authenticated: Scalars['Boolean'];
};
...
export type GetCityParametersInput = {
  ...
  /** Offset */
  readonly offset?: InputMaybe<Scalars['Float']>;
  /** Order */
...
export type Mutation = {
  ...
  readonly deleteRole?: Maybe<Scalars['Int']>;
  readonly deleteUserCities: Scalars['Int'];
...
export type MutationUpdateUserRoleArgs = {
  current_role: Scalars['Int'];
  new_role: Scalars['Int'];
  user: Scalars['Int'];
};
...
export type Weather = {
  ...
  /** Humidity. */
  readonly humidity: Scalars['Int'];
  /** Pressure. */
  readonly pressure: Scalars['Int'];
  /** Forecast temperature. */
  readonly temperature: Scalars['Float'];
  /** Temperature feels like. */
  readonly temperatureFeelsLike: Scalars['Float'];
  /** Weather condition. */
  readonly weather: Scalars['String'];
  /** Weather description. */
  readonly weatherDescription: Scalars['String'];
  /** Weather icon */
  readonly weatherIcon: Scalars['String'];
  /** Speed of wind. */
  readonly windSpeed: Scalars['Float'];
};
...
export type MeQuery = { readonly __typename?: 'Query', readonly me?: { readonly __typename?: 'User', readonly id: string, readonly email: string, readonly cities: ReadonlyArray<{ readonly __typename?: 'City', readonly name: string, readonly latitude: number, readonly longitude: number } | null> } | null };
